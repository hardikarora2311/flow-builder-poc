...
workflows.set('pice-los-journey', {
  ...
  nodes: [
    ...
    { id: 'n-digilocker-form', type: 'webhook', position: { x: 3840, y: 200 },
      data: {
        label: 'DigiLocker — Aadhaar OAuth',
        nodeType: 'webhook',
        webhookMode: 'redirect',
        variant: 'digilocker',
        redirectUrl: 'https://digilocker.meripehchaan.gov.in/oauth/authorize?client_id={{init.digilockerClientId}}&state={{session.sessionId}}',
        returnUrl: 'https://app.pice.one/callback/digilocker',
        webhookSecret: '',
        timeoutSeconds: 300,
      },
    },
    ...
    { id: 'n-selfie-form', type: 'webhook', position: { x: 5440, y: 200 },
      data: {
        label: 'HyperVerge KYC SDK — Selfie',
        nodeType: 'webhook',
        webhookMode: 'sdk',
        variant: 'selfie',
        sdkProvider: 'hyperverge',
        sdkCredentialsEndpoint: '/credit/loan/v1/hyperverge_credentials',
        sdkWorkflowId: 'pice_face_kyc_v2',
        timeoutSeconds: 180,
      },
    },
    ...
    { id: 'n-enach-form', type: 'webhook', position: { x: 7040, y: 200 },
      data: {
        label: 'NACH Bank Portal — Mandate Setup',
        nodeType: 'webhook',
        webhookMode: 'redirect',
        variant: 'enach',
        redirectUrl: 'https://nach.npci.org.in/initiate?utility={{init.utilityCode}}&amount={{response.mandateAmount}}&session={{session.sessionId}}',
        returnUrl: 'https://app.pice.one/callback/enach',
        webhookSecret: '',
        timeoutSeconds: 600,
      },
    },
